...
def open_popup():
    ...
    top.title("Detection")
    Label(top, text="Weapon Detected!")
    top.mainloop()
...
def run(
    ...
    if save_txt or save_img:
        ...
        print(os.getcwd()+'/'+str(save_dir)+'/'+dir_)
        img1 = Image.open(os.getcwd()+'/'+str(save_dir)+'/'+dir_)
        img1.show()
        # image_list = []
        # for f in glob.iglob(os.getcwd()+'/'+str(save_dir)+'/*'):
        #     im = Image.open(f)
        #     image_list.append(im)
        # print(os.getcwd())
        # img1 = Image.open(os.getcwd()+'/'+str(save_dir))
        # img1.show()
    if update:
        strip_optimizer(weights[0])  # update model (to fix SourceChangeWarning)


def parse_opt(weights1,src1, name='exp'):
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / weights1, help='model path or triton URL')
    parser.add_argument('--source', type=str, default=src1, help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default='640', help='(optional) dataset.yaml path')
    ...
    parser.add_argument('--dir_', type=str, default=name, help='img file name')
